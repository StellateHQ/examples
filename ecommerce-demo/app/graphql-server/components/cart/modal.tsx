...
import { CartItemFragment, CartModalFragment } from './fragments';
  ...
  return (
    <li className="flex w-full flex-col border-b border-neutral-300 dark:border-neutral-700">
      <div className="relative flex w-full flex-row justify-between px-1 py-4">
        ...
        <Link
          id={`cart-item-${i}`}
          href={`/graphql-server/product/${item.product.slug}`}
          onClick={closeCart}
...
export default function CartModal({ data }: { data: FragmentOf<typeof CartModalFragment> | null }) {
  const cart = readFragment(CartModalFragment, data);
