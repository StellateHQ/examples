//! # JSON Conversion
//!
//! The `gql_query::json` module contains utilities to convert from and to `serde_json` values.
//! Any values that are converted to `gql_query_rs`' structures are represented as AST values.
